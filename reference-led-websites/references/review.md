...
- For scroll effects, scroll down and back up, then resize. Check for stuck pins, layout jumps and inaccessible sections. For custom input handling, also run the source audit described in [library access](library-access.md).
